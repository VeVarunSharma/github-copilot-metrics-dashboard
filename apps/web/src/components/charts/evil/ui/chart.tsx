...
function ChartContainer({
  ...
  const overlayChildren = childrenArray.length > 1 ? childrenArray.slice(0, -1) : null;
  const chartChild = childrenArray.length > 1 ? childrenArray[childrenArray.length - 1] : children;
    ...
    <ChartContext.Provider value={{ config }}>
      ...
      >
        ...
        {isMounted ? (
          ...
          >
            {chartChild as React.ReactElement}
          </RechartsPrimitive.ResponsiveContainer>
        ) : (
