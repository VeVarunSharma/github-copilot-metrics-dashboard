import { getPayloadConfigFromPayload, getColorsCount, useChart } from "@/components/charts/evil/ui/chart";
...
const variantMap: Record<TooltipVariant, string> = {
  ...
  "frosted-glass": "bg-tooltip/90 text-tooltip-foreground backdrop-blur-sm",
};
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-border grid min-w-32 items-start gap-1.5 border px-2.5 py-1.5 text-xs shadow-xl",
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
                        <span className="text-[hsl(var(--tooltip-foreground)/0.72)]">
